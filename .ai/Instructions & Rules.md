...
General comment and documentation standards are defined in `@.ai/Documentation & Comments.md` (always applied).

### XML Documentation

- Document all **public** types and members with XML documentation (`///`).
- Include `<summary>`, and where relevant `<param>`, `<returns>`, and `<exception>`.
- Do not leave new or modified public types or members undocumented.
...
1. Code first.
2. Modular.
3. XML documentation on all public C# types and members (see **Documentation (C#)** above).
4. Comment quality follows `@.ai/Documentation & Comments.md`.
...
8. When updating `README.md`, follow `@.ai/Project README Generator.md`.
...
- No filler or TODO placeholders (see `@.ai/Documentation & Comments.md` for comment rules).
