...
- **Code Comments:** Follow `@.ai/Documentation & Comments.md` for comment and language standards.
...
3. C# code: C# 7.0 compliant view model logic; comments per `@.ai/Documentation & Comments.md`.
